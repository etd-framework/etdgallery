...
class EtdGalleryModelCategories extends JModelList {
	 ...
	 * @var		string
	 */
	public $_context = 'com_etdgallery.categories';
	 ...
	 * @var		string
	 */
	protected $_extension = 'com_etdgallery';
	...
	public function getItems($recursive = false)
	{
		...
		if (!isset($this->cache[$store])) {
			...
			$options = array();
			$options['countItems'] = $params->get('show_cat_num_images_cat', 1) || !$params->get('show_empty_categories_cat', 0);
			$categories = JCategories::getInstance('EtdGallery', $options);
